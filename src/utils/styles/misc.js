...
`;
// TODOL this isnt working because calcBreakpoints doesnt get triggered multiple times
const calcBreakpoints = (props, size) => {
    console.log("test")
    if(size === SIZES.XS){
        return (
            props.xs
...
export const Grid = styled.div`
    display: grid;
    /* if auto is not set as a prop, then take colSizes, if not set then default to splitting into 12 pieces */
    grid-template-columns: ${props => props.auto ? `repeat(auto-fit, minmax(250px, 1fr))` : (props.colSizes ?  props.colSizes : `1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr`)};
    ...
    */
    justify-content: ${props => props.horizAlign ? props.horizAlign : ""};  
    align-content: ${props => props.vertAlign ? props.vertAlign : ""};  

    /* Align all cells in the grid with this default */
    justify-items: ${props => props.horizAlignCells ? props.horizAlignCells : ""};
    align-items: ${props => props.vertAlignCells ? props.vertAlignCells : ""};

    div {
        padding: ${props => props.cellPadding ? props.cellPadding : "0"};
    }
`;

export const Col = styled.div`
    justify-self: ${props => props.horizAlign ? props.horizAlign : ""};
    align-self: ${props => props.vertAlign ?  props.vertAlign : ""};
    text-align: ${props => props.textAlign ? props.textAlign : "left"};
    background-color: ${props => props.bgColor};
            
    @media (max-width: 700px) {
        grid-column: span ${props => calcBreakpoints(props, SIZES.XS)};
    }

    @media (min-width: 701px), (max-width: 900px) {
        grid-column: span ${props => calcBreakpoints(props, SIZES.SM)};
    }
    
    @media (min-width: 901px), (max-width: 1200px) {
        grid-column: span ${props => calcBreakpoints(props, SIZES.MD)};
    }

    @media (min-width: 1201px), (max-width: 1600px) {
        grid-column: span ${props => calcBreakpoints(props, SIZES.LG)};
    }

    @media (min-width: 1601px), (max-width: 2000px) {
        grid-column: span ${props => calcBreakpoints(props, SIZES.XL)};
    }
`;
