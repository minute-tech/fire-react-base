...
export const HeadingFont = css`
    color: ${props => props.theme?.color?.font?.heading ?? "black"};
    font-family: ${props => props.theme?.font?.heading.name ?? "Arial, Helvetica, sans-serif"};
`;

export const BodyFont = css`
    color: ${props => props.theme?.color?.font?.body ?? "black"};
    font-family: ${props => props.theme?.font?.body.name ?? "Arial, Helvetica, sans-serif"};
`;

export const BodyFontColor = styled.span`
    color: ${props => props.theme?.color?.font?.body ?? "black"};
`;
...
export const Body = styled.p`
    ...
    vertical-align: ${props => props.verticalAlign ? props.verticalAlign : "baseline"};
...
export const ALink = styled.a`
    cursor: pointer;
    ${BodyFont};
    color: ${props => props.color ? props.color : (props.theme?.color?.font?.link ?? "navy")} !important;
    text-decoration: none;
    transition: color 0.15s linear;
    margin: ${props => props.margin ? props.margin : "0"};
    &:hover {
        color: ${props => (props.theme?.color?.yellow || "gold")} !important;
        text-decoration: none;
    }
`;
...
export const ErrorText = styled.div`
    ${BodyFont};
    color: ${props => (props.theme?.color?.red ?? "firebrick")} !important;
